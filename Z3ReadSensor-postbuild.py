...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/C:/Users/FPT/SimplicityStudio/SimplicityStudio/v4/developer/toolchains/gnu_arm/7.2_2017q4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    print (" ")
    EBL_COMMAND = START_FLAGS + shortPath(r"C:\Users\FPT\SimplicityStudio\SimplicityStudio\v4\developer\adapter_packs\commander\commander.exe").replace(
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"C:\Users\FPT\SimplicityStudio\SimplicityStudio\v4\developer\adapter_packs\commander\commander.exe").replace(
